...
public partial class SandboxContext : DbContext
{
    ...
    public virtual DbSet<CategoryAveragePrice> CategoryAveragePrices { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CategoryAveragePrice>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("category_average_prices");
        ...
        {
            entity.HasKey(e => e.AttendeesId).HasName("event_attendees_pkey");

            entity.ToTable("event_attendees");

            entity.HasIndex(e => e.Email, "event_attendees_email_key").IsUnique();
